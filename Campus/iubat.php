...
<body>
	...
	<div id="top_portion">
		<p id="name"> International University of Business Agriculture and Technology</p>
	...
	<div id="data">
		...
		<a class= "download1" href="iubat/1.pdf" target="_blank">DOWNLOAD-1</a><br><br>

	</div><br><br>


		<p>Tuition Fee</p>
		<img src="iubat/fee1.JPG" alt="" >
		<img src="iubat/fee2.JPG" alt="" ><br><br><br><br>


		<a class="button1" id="full_list" target="_blank" href="https://iubat.edu">
	   <button id="full_list1">Click Here To Visit Main Website Of  IUBAT (https://iubat.edu) </button>
		</a>
