...
<body>
	...
	<div id="top_portion">
		<p id="name"> City University, Bangladesh</p>
	...
	<div id="data">
		...
		<a class= "download1" href="cub/1.pdf" target="_blank">DOWNLOAD-1</a><br><br>
		...
		<p>Tuition Fee</p>
		<img src="cub/fee1.JPG" alt="" >
		<img src="cub/fee2.JPG" alt="" ><br><br><br><br>

		<a class="button1" id="full_list" target="_blank" href="http://www.cityuniversity.edu.bd">
	   <button id="full_list1">Click Here To Visit Main Website Of  City University, Bangladesh (http://www.cityuniversity.edu.bd) </button>
		</a>
