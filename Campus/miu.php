...
<body>
	...
	<div id="top_portion">
		<p id="name">Manarat International University  </p>
	...
	<div id="data">
		...
		<a class= "download1" href="miu/1.pdf" target="_blank">DOWNLOAD-1</a><br><br>
		<a class= "download1" href="miu/2.pdf" target="_blank">DOWNLOAD-2</a><br><br>
	</div><br><br>



		<p> Requirement</p>
		<img src="miu/min1.JPG" alt="" >
		<img src="miu/min2.JPG" alt="" ><br><br><br><br>


		<p>Tuition Fee</p>
		<img src="miu/fee1.JPG" alt="" ><br><br><br><br>


		<a class="button1" id="full_list" target="_blank" href="http://www.manarat.ac.bd">
	   <button id="full_list1">Click Here To Visit Main Website Of  MIU (http://www.manarat.ac.bd) </button>
		</a>
