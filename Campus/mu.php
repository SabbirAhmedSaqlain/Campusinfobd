...
<body>
	...
	<div id="top_portion">
		<p id="name">The Millennium University  </p>
	...
	<div id="data">
		...
		<a class= "download1" href="mu/1.pdf" target="_blank">DOWNLOAD-1</a><br><br>
	</div><br><br>


		<img src="mu/1.JPG" alt="" ><br><br><br><br>


		<a class="button1" id="full_list" target="_blank" href="http://themillenniumuniversity.edu.bd/">
	   <button id="full_list1">Click Here To Visit Main Website Of  The Millennium University (themillenniumuniversity.edu.bd/) </button>
		</a>
