...
<body>
	...
	<div id="data">
		...
		<a class= "download1" href="gub/1.pdf" target="_blank">DOWNLOAD-1</a><br><br>
		<a class= "download1" href="gub/2.pdf" target="_blank">DOWNLOAD-2</a><br><br>
	</div><br><br><br><br><br><br>




		<img src="gub/1.JPG" alt="" ><br><br><br><br><br><br>
		


		<p>Tuition Fee</p>
		<img src="gub/2.JPG" alt="" ><br><br><br><br>
		<img src="gub/fee1.JPG" alt="" ><br><br><br><br>


		<a class="button1" id="full_list" target="_blank" href="http://www.green.edu.bd">
	   <button id="full_list1">Click Here To Visit Main Website Of  Green University (http://www.green.edu.bd) </button>
		</a>
