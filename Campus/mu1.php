...
<body>
	...
	<div id="top_portion">
		<p id="name">Metropolitan University  </p>
	...
	<div id="data">
		...
		<a class= "download1" href="mu1/1.pdf" target="_blank">DOWNLOAD-1</a><br><br>

	</div><br><br>



		<img src="mu1/1.JPG" alt="" ><br><br><br><br>


		<img src="mu1/2.JPG" alt="" ><br><br><br><br>

		<img src="mu1/3.JPG" alt="" ><br><br><br><br>


		<img src="mu1/4.JPG" alt="" ><br><br><br><br>

		<a class="button1" id="full_list" target="_blank" href="http://metrouni.edu.bd/">
	   <button id="full_list1">Click Here To Visit Main Website Of  Metropolitan University (http://metrouni.edu.bd/) </button>
		</a>
