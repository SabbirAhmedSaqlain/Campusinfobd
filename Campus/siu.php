...
<body>
	...
	<div id="top_portion">
		<p id="name"> Sylhet International University</p>
	...
	<div id="data">
		...
		<a class= "download1" href="siu/1.pdf" target="_blank">DOWNLOAD-1</a><br><br>
		...
		<img src="siu/1.JPG" alt="" ><br><br><br><br>

		<img src="siu/2.JPG" alt="" ><br><br><br><br>
		<img src="siu/3.JPG" alt="" ><br><br><br><br>


		<a class="button1" id="full_list" target="_blank" href="http://siu.edu.bd/">
	   <button id="full_list1">Click Here To Visit Main Website Of  Sylhet International University(http://siu.edu.bd/) </button>
		</a>
