...
<body>
	...
	<div id="top_portion">
		<p id="name">North Western University, Bangladesh  </p>
	...
	<div id="data">
		...
		<a class= "download1" href="nwu/1.pdf" target="_blank">DOWNLOAD-1</a><br><br>
		...
		<img src="nwu/2.JPG" alt="" height="800px" width="800px" ><br><br><br><br>
		


		<p>Tuition Fee</p>
		<img src="nwu/1.JPG" alt=""  height="800px" width="800px" ><br><br><br><br>
		<img src="nwu/fee1.JPG" alt="" height="800px" width="800px"><br><br><br><br>


		<a class="button1" id="full_list" target="_blank" href="http://www.nwu.edu.bd/">
	    <button id="full_list1">Click Here To Visit Main Website Of  NWU (www.nwu.edu.bd) </button>
		</a>
