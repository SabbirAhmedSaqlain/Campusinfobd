...
<body>
	...
	<div id="top_portion">
		<p id="name">Dhaka International University</p>
	...
	<div id="data">
		...
		<a class= "download1" href="diu1/1.pdf" target="_blank">DOWNLOAD-1</a><br><br>

	</div><br><br><br><br><br>


		<p>Department List</p>
		<img src="diu1/dept1.JPG" alt="" >
		<img src="diu1/dept2.JPG" alt="" >
		<img src="diu1/dept2.JPG" alt="" ><br><br><br><br>

		<p>Requirement </p>
		<img src="diu1/min1.JPG" alt="" >




		<a class="button1" id="full_list" target="_blank" href="https://daffodilvarsity.edu.bd/">
	   <button id="full_list1">Click Here To Visit Main Website Of  DIU (https://daffodilvarsity.edu.bd/) </button>
		</a>
