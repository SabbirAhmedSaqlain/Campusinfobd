...
<body>
	...
	<div id="top_portion">
		<p id="name">Khwaja Yunus Ali University  </p>
	...
	<div id="data">
		...
		<a class= "download1" href="kyau/1.pdf" target="_blank">DOWNLOAD-1</a><br><br>
	</div><br><br>



		<p> Requirement</p>
		<img src="kyau/1.JPG" alt="" >
		<img src="kyau/2.JPG" alt="" ><br><br><br><br>


		<p>Tuition Fee</p>
		<img src="kyau/3.JPG" alt="" ><br><br><br><br>


		<a class="button1" id="full_list" target="_blank" href="http://www.kyau.edu.bd">
	   <button id="full_list1">Click Here To Visit Main Website Of  Khwaja Yunus Ali University (http://www.kyau.edu.bd) </button>
		</a>
