...
<body>
	...
	<div id="top_portion">
		<p id="name">Bangladesh Islami University</p>
	...
	<div id="data">
		...
		<a class= "download1" href="biu/1.pdf" target="_blank">DOWNLOAD-1</a><br><br>

		<a class= "download1" href="biu/2.pdf" target="_blank">DOWNLOAD-1</a><br><br>
		...
		<img src="biu/1.JPG" alt="" ><br><br>
		<img src="biu/2.JPG" alt="" ><br><br>

		<img src="biu/3.JPG" alt="" ><br><br><br><br>


		<a class="button1" id="full_list" target="_blank" href="http://biu.ac.bd">
	   <button id="full_list1">Click Here To Visit Main Website Of  BIU (http://biu.ac.bd </button>
		</a>
