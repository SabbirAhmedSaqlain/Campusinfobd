...
<body>
	...
	<div id="top_portion">
		<p id="name"> Pundra University of Science and Technology</p>
	...
	<div id="data">
		...
		<a class= "download1" href="pust1/1.pdf" target="_blank">DOWNLOAD-1</a><br><br>

	</div><br><br>


		<p>Department</p>
		<img src="pust1/1.JPG" alt="" ><br><br><br><br>


		<a class="button1" id="full_list" target="_blank" href="http://pundrouniversity.edu.bd">
	   <button id="full_list1">Click Here To Visit Main Website Of  Pundra University of Science and Technology  (http://pundrouniversity.edu.bd) </button>
		</a>
