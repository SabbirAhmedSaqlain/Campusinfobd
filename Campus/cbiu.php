...
<body>
	...
	<div id="top_portion">
		<p id="name"> COX'S BAZAR INTERNATIONAL UNIVERSITY</p>
	...
	<div id="data">
		...
		<a class= "download1" href="cbiu/1.pdf" target="_blank">DOWNLOAD-1</a><br><br>
		...
		<p> Requirement</p>
		<img src="cbiu/1.JPG" alt="" ><br><br><br><br>





		<a class="button1" id="full_list" target="_blank" href="http://www.cbiu.ac.bd">
	   <button id="full_list1">Click Here To Visit Main Website Of  CBIU (http://www.cbiu.ac.bd) </button>
		</a>
