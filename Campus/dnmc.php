...
<body>
	...
	<div id="top_portion">
		<p id="name">Dhaka National Medical College</p>
	...
	<div id="notice"> 
 	...
 	<div id="data">
		...
		<a class= "download1" href="dnmc/notice.pdf" target="_blank">DOWNLOAD-1</a><br><br>
		...
		<p> Requirement</p>
		<img src="dnmc/1.JPG" alt="" >
		<img src="dnmc/2.JPG" alt="" >
		<br><br><br>
		...
		<a class="button1" id="full_list" target="_blank" href="http://dnmc.edu.bd/">
	   <button id="full_list1">Click Here To Visit Main Website Of  Dhaka National Medical College (http://dnmc.edu.bd/) </button>
		</a>
