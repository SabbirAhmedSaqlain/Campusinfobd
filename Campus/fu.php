...
<head>
	...
	<div id="data">
		...
		<a class= "download1" href="fu/1.pdf" target="_blank">DOWNLOAD-1</a><br><br>
	</div><br><br>
		...
		<p>Date</p>
		<img src="fu/1.JPG" alt="" ><br><br><br><br>


		<a class="button1" id="full_list" target="_blank" href="http://feniuniversity.edu.bd/">
	   <button id="full_list1">Click Here To Visit Main Website Of  Feni University (http://feniuniversity.edu.bd) </button>
		</a>
