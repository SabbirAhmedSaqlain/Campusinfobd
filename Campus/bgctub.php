...
<body>
	...
	<div id="top_portion">
		<p id="name">Begum Gulchemonara Trust University</p>
	...
	<div id="data">
		...
		<a class= "download1" href="bgctub/1.pdf" target="_blank">DOWNLOAD-1</a><br><br>
		...
		<p>Tuition Fee</p>
		<img src="bgctub/1.JPG" alt="" >
		<img src="bgctub/2.JPG" alt="" ><br><br><br><br>


		<a class="button1" id="full_list" target="_blank" href="http://www.bgctub-edu.net/">
	   <button id="full_list1">Click Here To Visit Main Website Of  BGCTUB (www.bgctub-edu.net) </button>
		</a>
