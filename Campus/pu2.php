...
<body>
	...
	<div id="data">
		...
		<a class= "download1" href="pu2/1.pdf" target="_blank">DOWNLOAD-1</a><br><br>

	</div><br><br>



		<img src="pu2/1.JPG" alt="" >
		<img src="pu2/2.JPG" alt="" ><br><br><br><br>





		<a class="button1" id="full_list" target="_blank" href="http://www.primeuniversity.edu.bd">
	   <button id="full_list1">Click Here To Visit Main Website Of Prime University (http://www.primeuniversity.edu.bd) </button>
		</a>
