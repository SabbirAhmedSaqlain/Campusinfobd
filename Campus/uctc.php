...
<body>
	...
	<p id="name"></p>
	<div id="top_portion">
		<p id="name">University of Creative Technology Chittagong </p>
	...
	<div id="data">
		...
		<a class= "download1" href="uctc/1.pdf" target="_blank">DOWNLOAD-1</a><br><br>
		...
		<p> Requirement</p>
		<img src="uctc/1.jpg" alt="" ><br><br><br><br>




		<a class="button1" id="full_list" target="_blank" href="https://www.facebook.com/UctcEduBd/">
	   <button id="full_list1">Click Here To Visit Main Website Of  UCTC </button>
		</a>
