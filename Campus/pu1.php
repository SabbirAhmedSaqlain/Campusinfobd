...
<body>
	...
	<div id="top_portion">
		<p id="name"> Presidency University</p>
	...
	<div id="data">
		...
		<a class= "download1" href="pu1/1.pdf" target="_blank">DOWNLOAD-1</a><br><br>
		...
		<p>Tuition Fee</p>
		<img src="pu1/1.JPG" alt="" >
		<img src="pu1/2.JPG" alt="" ><br><br><br><br>


		<a class="button1" id="full_list" target="_blank" href="http://www.presidency.edu.bd">
	   <button id="full_list1">Click Here To Visit Main Website Of Presidency University (www.presidency.edu.bd) </button>
		</a>
