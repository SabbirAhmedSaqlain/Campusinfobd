...
<body>
	...
	<div id="top_portion">
		<p id="name">Rajshahi Science & Technology University</p>
	...
	<div id="data">
		...
		<a class= "download1" href="rstu/1.pdf" target="_blank">DOWNLOAD-1</a><br><br>
	</div><br><br>



		<p> Requirement</p>
		<img src="rstu/3.JPG" alt="" ><br><br><br><br>


		<p>Tuition Fee</p>
		<img src="rstu/1.JPG" alt="" >
		<img src="rstu/2.JPG" alt="" ><br><br><br><br>


		<a class="button1" id="full_list" target="_blank" href="http://www.rstu.edu.bd/">
	   <button id="full_list1">Click Here To Visit Main Website Of  RSTU (www.rstu.edu.bd/) </button>
		</a>
