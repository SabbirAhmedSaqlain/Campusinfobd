...
<body>
	...
	<div id="top_portion">
		<p id="name">Bangladesh Army University of Engineering & Technology</p>
	...
	<div id="data">
		...
		<a class= "download1" href="bauet/1.pdf" target="_blank">DOWNLOAD-1</a><br><br>
	
		<a class= "download1" href="bauet/notice.pdf" target="_blank">DOWNLOAD-2</a><br><br>
	</div>
		...
		<p>Department List</p>
		<img src="bauet/dept1.JPG" alt="" ><br><br><br>


		<p> Requirement</p>
 
		<img src="bauet/1.JPG" alt="" ><br><br><br><br>


		<p>Tuition Fee</p>
 
		<img src="bauet/2.JPG" alt="" ><br><br><br><br>


		<a class="button1" id="full_list" target="_blank" href="http://bauet.ac.bd/pages">
	   <button id="full_list1">Click Here To Visit Main Website Of BAUET (http://bauet.ac.bd/pages) </button>
		</a>
