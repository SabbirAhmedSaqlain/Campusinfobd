...
<body>
	...
	<div id="data">
		...
		<a class= "download1" href="aiub/1.pdf" target="_blank">DOWNLOAD-1</a><br><br>
		<a class= "download1" href="aiub/2.pdf" target="_blank">DOWNLOAD-2</a><br><br>
	</div><br><br>



		<p> Requirement</p>
		<img src="aiub/min1.JPG" alt="" >
		<img src="aiub/min2.JPG" alt="" ><br><br><br><br>


		<p>Tuition Fee</p>
		<img src="aiub/fee1.JPG" alt="" ><br><br><br><br>


		<a class="button1" id="full_list" target="_blank" href="http://www.aiub.edu/">
	   <button id="full_list1">Click Here To Visit Main Website Of  AIUB (www.aiub.edu) </button>
		</a>
