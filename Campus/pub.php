...
<body>
	...
	<div id="top_portion">
		<p id="name"> People's University of Bangladesh</p>
	...
	<div id="data">
		...
		<a class= "download1" href="pub/1.pdf" target="_blank">DOWNLOAD-1</a><br><br>
		...
		<p> Requirement</p>
		<img src="pub/1.JPG" alt="" ><br><br><br><br>



		<a class="button1" id="full_list" target="_blank" href="http://www.newsite.pub.ac.bd/">
	   <button id="full_list1">Click Here To Visit Main Website Of  PUB (www.newsite.pub.ac.bd/) </button>
		</a>
