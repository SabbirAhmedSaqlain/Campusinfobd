...
<body>
	...
	<div id="top_portion">
		<p id="name">University of Development Alternative </p>
	...
	<div id="data">
		...
		<a class= "download1" href="uoda/1.pdf" target="_blank">DOWNLOAD-1</a><br><br>
	</div><br><br>



		<p> Requirement</p>
		<img src="uoda/1.JPG" alt="" ><br><br><br><br>




		<a class="button1" id="full_list" target="_blank" href="http://uoda.edu.bd/">
	   <button id="full_list1">Click Here To Visit Main Website Of  University of Development Alternative(http://uoda.edu.bd/) </button>
		</a>
