...
<body>
	...
	<div id="top_portion">
		<p id="name">Asian University of Bangladesh</p>
	...
	<div id="data">
		...
		<a class= "download1" href="aub/1.pdf" target="_blank">DOWNLOAD-1</a><br><br>
		...
		<img src="aub/notice.png" alt="" ><br><br><br><br>


		<p>Tuition Fee</p>
		<img src="aub/fee.png" alt="" ><br><br><br><br>


		<a class="button1" id="full_list" target="_blank" href="http://www.aub.edu.bd/">
	   <button id="full_list1">Click Here To Visit Main Website Of  AUB (http://www.aub.edu.bd/) </button>
		</a>
