...
<body>
	...
	<div id="data">
		...
		<a class= "download1" href="uu/1.pdf" target="_blank">DOWNLOAD-1</a><br><br>
		<a class= "download1" href="uu/2.pdf" target="_blank">DOWNLOAD-2</a><br><br>
	</div><br><br>



		<p> Requirement</p>
		<img src="uu/1.JPG" alt="" >
		<img src="uu/2.JPG" alt="" ><br><br><br><br>

		<img src="uu/3.JPG" alt="" ><br><br><br><br>


		<a class="button1" id="full_list" target="_blank" href="http://uttarauniversity.edu.bd/">
	   <button id="full_list1">Click Here To Visit Main Website Of  Uttara University(http://uttarauniversity.edu.bd/) </button>
		</a>
