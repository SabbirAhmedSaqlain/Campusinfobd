...
<body>
	...
	<div id="top_portion">
		<p id="name">North East University Bangladesh  </p>
	...
	<div id="data">
		...
		<a class= "download1" href="neub/1.pdf" target="_blank">DOWNLOAD-1</a><br><br>
		<a class= "download1" href="neub/2.pdf" target="_blank">DOWNLOAD-2</a><br><br>
	</div><br><br>



		<p> Requirement</p>
		<img src="neub/1.JPG" alt="" >


		<a class="button1" id="full_list" target="_blank" href="http://neub.edu.bd/">
	   <button id="full_list1">Click Here To Visit Main Website Of  North East University Bangladesh(http://neub.edu.bd/) </button>
		</a>
