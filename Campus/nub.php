...
<body>
	...
	<div id="top_portion">
		<p id="name">Northern University, Bangladesh  </p>
	...
	<div id="data">
		...
		<a class= "download1" href="nub/1.pdf" target="_blank">DOWNLOAD-1</a><br><br>
		<a class= "download1" href="nub/2.pdf" target="_blank">DOWNLOAD-2</a><br><br>
	</div><br><br>



		<p> Requirement</p>
		<img src="nub/min1.JPG" alt="" >
		<img src="nub/min2.JPG" alt="" ><br><br><br><br>


		<p>Tuition Fee</p>
		<img src="nub/fee1.JPG" alt="" ><br><br><br><br>


		<a class="button1" id="full_list" target="_blank" href="http://nub.ac.bd/">
	   <button id="full_list1">Click Here To Visit Main Website Of  NUB (http://nub.ac.bd/) </button>
		</a>
