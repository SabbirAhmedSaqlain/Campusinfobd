...
<body>
	...
	<div id="top_portion">
		<p id="name">Atish Dipankar University of Science and Technology</p>
	...
	<div id="data">
		...
		<a class= "download1" href="adust/1.pdf" target="_blank">DOWNLOAD-1</a><br><br>
	</div><br><br>




		<img src="adust/1.JPG" alt="" ><br><br>
		


		<p>Tuition Fee</p>
		<img src="adust/2.JPG" alt="" ><br><br>
		<img src="adust/3.JPG" alt="" ><br><br><br><br>


		<a class="button1" id="full_list" target="_blank" href="http://www.adust.edu.bd/">
	   <button id="full_list1">Click Here To Visit Main Website Of  ADUST (www.adust.edu.bd) </button>
		</a>
