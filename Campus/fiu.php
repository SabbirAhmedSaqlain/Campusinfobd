...
<body>
	...
	<div id="top_portion">
		<p id="name"> Fareast International University</p>
	...
	<div id="data">
		...
		<a class= "download1" href="fiu/1.pdf" target="_blank">DOWNLOAD-1</a><br><br>
		...
		<p> Requirement</p>
		<img src="fiu/1.JPG" alt="" ><br><br><br><br>
		<p> Fee</p>
		<img src="fiu/2.JPG" alt="" ><br><br><br><br>


		<a class="button1" id="full_list" target="_blank" href="http://www.fiu.edu.bd/">
	   <button id="full_list1">Click Here To Visit Main Website Of  Fareast International University (http://www.fiu.edu.bd/) </button>
		</a>
