...
<body>
	...
	<div id="top_portion">
		<p id="name">Victoria University of Bangladesh </p>
	...
	<div id="data">
		...
		<a class= "download1" href="vub/1.pdf" target="_blank">DOWNLOAD-1</a><br><br>
		...
		<p> Requirement</p>
		<img src="vub/1.JPG" alt="" >
		<img src="vub/2.JPG" alt="" ><br><br><br><br>



		<a class="button1" id="full_list" target="_blank" href="http://vub.edu.bd/">
	   <button id="full_list1">Click Here To Visit Main Website Of  Victoria University(http://vub.edu.bd/) </button>
		</a>
